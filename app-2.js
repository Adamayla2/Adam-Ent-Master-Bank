...
window.ENTApp.version='step35-opt';
        ...
        //             -> Chapter
        //
        //  Source of truth: the Scott-Brown Table of Contents text supplied
        //  by the user. Only Otology and Rhinology came with a full chapter
        //  list, so only those two are fully populated. Every other subject
        //  below is registered by name only (chapters: [], pending: true) -
        //  DO NOT add chapters to a pending subject/part without a verified
        //  source list. Head and Neck's 8 Parts were supplied by name, so
        //  they're registered too, but with no chapters yet (also pending).
        //
        //  chapterNumber is populated only where it's directly supported:
        //  Otology's own worked example confirmed chapter 1 = "Physiology
        //  of hearing" and the list order, so 1-40 follows the given order.
        //  Rhinology's numbers are unknown (no anchor point was given) and
        //  are left null rather than guessed - do not assume they start at
        //  1, since Scott-Brown numbers chapters continuously across the
        //  whole book (the user's own Head & Neck example used chapter 183).
        //
        ...
        const SCOTT_BROWN_TAXONOMY = [
            {
                ...
                chapters: [
                    ...
                    { chapterId: 'sb_otology_19', chapterNumber: 19, chapter: 'Anatomy of the cochlea and vestibular system' },
                    ...
                    { chapterId: 'sb_otology_26', chapterNumber: 26, chapter: 'Keratosis obturans and cholesteatoma' },
            ...
            { subjectId: 'lateral_skull_base', subject: 'Lateral Skull Base', pending: true, parts: null, chapters: [] },
            {
                subjectId: 'rhinology', subject: 'Rhinology', pending: false, parts: null,
                chapters: [
                    { chapterId: 'sb_rhinology_01', chapterNumber: null, chapter: 'Anatomy of the nose and paranasal sinuses' },
                    { chapterId: 'sb_rhinology_02', chapterNumber: null, chapter: 'Physiology of the nose and paranasal sinuses' },
                    { chapterId: 'sb_rhinology_03', chapterNumber: null, chapter: 'Radiological investigations used in rhinology' },
                    { chapterId: 'sb_rhinology_04', chapterNumber: null, chapter: 'Outpatient assessment: Nose and sinuses' },
                    { chapterId: 'sb_rhinology_05', chapterNumber: null, chapter: 'Nasal airway objective measurements' },
                    { chapterId: 'sb_rhinology_06', chapterNumber: null, chapter: 'Relationship between the upper and lower respiratory tract' },
                    { chapterId: 'sb_rhinology_07', chapterNumber: null, chapter: 'Olfaction and abnormalities of smell' },
                    { chapterId: 'sb_rhinology_08', chapterNumber: null, chapter: 'Rhinitis' },
                    { chapterId: 'sb_rhinology_09', chapterNumber: null, chapter: 'Acute rhinosinusitis' },
                    { chapterId: 'sb_rhinology_10', chapterNumber: null, chapter: 'Rhinosinusitis: Definitions, classification and diagnosis' },
                    { chapterId: 'sb_rhinology_11', chapterNumber: null, chapter: 'Fungal rhinosinusitis' },
                    { chapterId: 'sb_rhinology_12', chapterNumber: null, chapter: 'Management of chronic rhinosinusitis' },
                    { chapterId: 'sb_rhinology_13', chapterNumber: null, chapter: 'The frontal sinus' },
                    { chapterId: 'sb_rhinology_14', chapterNumber: null, chapter: 'Complications of rhinosinusitis' },
                    { chapterId: 'sb_rhinology_15', chapterNumber: null, chapter: 'Mucoceles of the paranasal sinuses' },
                    { chapterId: 'sb_rhinology_16', chapterNumber: null, chapter: 'Diagnosis and management of facial pain' },
                    { chapterId: 'sb_rhinology_17', chapterNumber: null, chapter: 'Management of enlarged turbinates' },
                    { chapterId: 'sb_rhinology_18', chapterNumber: null, chapter: 'Nasal septum and nasal valve' },
                    { chapterId: 'sb_rhinology_19', chapterNumber: null, chapter: 'Nasal septal perforation' },
                    { chapterId: 'sb_rhinology_20', chapterNumber: null, chapter: 'Treatment of nasal and facial fractures' },
                    { chapterId: 'sb_rhinology_21', chapterNumber: null, chapter: 'Epistaxis' },
                    { chapterId: 'sb_rhinology_22', chapterNumber: null, chapter: 'Granulomatous conditions of the nose' },
                    { chapterId: 'sb_rhinology_23', chapterNumber: null, chapter: 'Benign sinonasal tumours' },
                    { chapterId: 'sb_rhinology_24', chapterNumber: null, chapter: 'Lacrimal dysfunction' },
                    { chapterId: 'sb_rhinology_25', chapterNumber: null, chapter: 'History of modern rhinology' }
                ]
            },
            { subjectId: 'anterior_skull_base', subject: 'Anterior Skull Base', pending: true, parts: null, chapters: [] },
            { subjectId: 'facial_plastic_surgery', subject: 'Facial Plastic Surgery', pending: true, parts: null, chapters: [] },
            { subjectId: 'paediatrics', subject: 'Paediatrics', pending: true, parts: null, chapters: [] },
            { subjectId: 'laryngology', subject: 'Laryngology', pending: true, parts: null, chapters: [] },
            {
                subjectId: 'head_neck', subject: 'Head and Neck', pending: true, chapters: null,
                parts: [
                    { partId: 'head_neck_cancer', partNumber: 1, part: 'Head and neck cancer', chapters: [] },
                    { partId: 'upper_aerodigestive_tract', partNumber: 2, part: 'Upper aerodigestive tract', chapters: [] },
                    { partId: 'salivary_glands', partNumber: 3, part: 'Salivary glands', chapters: [] },
                    { partId: 'skin', partNumber: 4, part: 'Skin', chapters: [] },
                    { partId: 'skull_base_hn', partNumber: 5, part: 'Skull base', chapters: [] },
                    { partId: 'reconstruction', partNumber: 6, part: 'Reconstruction', chapters: [] },
                    { partId: 'radiation_medical_oncology', partNumber: 7, part: 'Radiation and medical oncology', chapters: [] },
                    { partId: 'miscellaneous_hn', partNumber: 8, part: 'Miscellaneous', chapters: [] }
                ]
            },
            { subjectId: 'head_neck_endocrine', subject: 'Head and Neck Endocrine', pending: true, parts: null, chapters: [] }
        ];
