...
async function openReclassifyModal(questionId){
 ...
 const subjectOptions = (q.subject && !ALL_SUBJECTS.includes(q.subject)) ? [q.subject, ...ALL_SUBJECTS] : ALL_SUBJECTS;

 function chaptersFor(subject){
     const list = (subject && ENT_DATA[subject]) ? [...ENT_DATA[subject]] : [];
